...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className={`relative w-full h-screen overflow-hidden bg-[#060b12] ${className}`}>
      <style>{`
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
        ...
        {trustBadge && (
          <div className="mb-8 animate-fade-in-down">
            <div className="flex items-center gap-2 px-6 py-3 backdrop-blur-md rounded-full text-sm"
              style={{
              ...
              <span style={{ color: 'rgba(34,211,238,.9)' }}>{trustBadge.text}</span>
            </div>
          </div>
        )}
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto animate-fade-in-up animation-delay-600">
            <p className="text-lg md:text-xl lg:text-2xl font-light leading-relaxed"
              style={{ color: 'rgba(226,232,240,.9)' }}>
              {subtitle}
            </p>
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-fade-in-up animation-delay-800">
              {buttons.primary && (
                <button
                  ...
                  onMouseEnter={e => {
                    ...
                    (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 6px 22px rgba(34,211,238,.38)';
                  }}
                  onMouseLeave={e => {
              ...
              {buttons.secondary && (
                <button
                  ...
                  className="px-8 py-4 rounded-full font-semibold text-lg backdrop-blur-sm"
                  style={{
                    background: 'rgba(34,211,238,.08)',
                  ...
                  onMouseEnter={e => {
                    (e.currentTarget as HTMLButtonElement).style.transform = 'translateY(-2px)';
                    (e.currentTarget as HTMLButtonElement).style.background = 'rgba(34,211,238,.14)';
                    (e.currentTarget as HTMLButtonElement).style.borderColor = 'rgba(34,211,238,.4)';
                  }}
                  onMouseLeave={e => {
                    (e.currentTarget as HTMLButtonElement).style.transform = '';
                    (e.currentTarget as HTMLButtonElement).style.background = 'rgba(34,211,238,.08)';
                    (e.currentTarget as HTMLButtonElement).style.borderColor = 'rgba(34,211,238,.25)';
                  }}
                >
...
// Teal-shifted nebula shader — replaces warm orange/amber tones with cyan/teal
const defaultShaderSource = `#version 300 es
/*********
* made by Matthias Hurrle (@atzedent)
* color-shifted to teal/cyan for portfolio theme
*/
precision highp float;
out vec4 O;
